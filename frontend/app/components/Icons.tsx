// Inline SVG icon set + the "seal" mark. Ported from design/ui.jsx.
// The seal is decorative/original — not a real government seal.
...
const ICONS: Record<string, string> = {
  ...
  scale:
    "M12 3v18M5 21h14M7 7h10M7 7 4 14a3 3 0 0 0 6 0L7 7Zm10 0-3 7a3 3 0 0 0 6 0l-3-7ZM12 3 7 7m5-4 5 4",
  ...
  alert:
    "M12 9v4m0 4h.01M10.3 4.3 2.5 18a2 2 0 0 0 1.7 3h15.6a2 2 0 0 0 1.7-3L13.7 4.3a2 2 0 0 0-3.4 0Z",
...
export function Seal({ className, style }: { className?: string; style?: CSSProperties }) {
  return (
